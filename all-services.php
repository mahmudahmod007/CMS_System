  ...
  <div class="container-fluid  top2 ">
   <div class="container top1">
     <div class="row">
		...
		<img src="images/call.png"/><label>Toll Free Number :</label>
		<p>+918486821276</p>		
		</div>
         ...
         <div class="row footer1">
			 ...
			 <div class="col-sm-3">
				 ...
				 <ul class="list-unstyled">
					 ...
					 <li><br><br></li>
					  <li><img src="images/contact.png"> &nbsp +91- 8486821276</li>
					  <li><img src="images/email.png"> &nbsp  mahmud@gmail.com </li>
					  <li><label>Hailakandi,Assam,India</label></li>
				 </ul>
			 </div>
			...
			<div class="col-sm-6">
			<strong  style="float:left;color:gray;"> ©Courier Management System 2022.All right reserved</strong>
			</div>
